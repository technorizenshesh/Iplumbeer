...
//            }
        ...
        try {
            ...
            receiveCallPendingIntent = PendingIntent.getBroadcast(AppController.getContext(), 1200, receiveCallAction, PendingIntent.FLAG_UPDATE_CURRENT);
            cancelCallPendingIntent = PendingIntent.getBroadcast(AppController.getContext(), 1201, cancelCallAction, PendingIntent.FLAG_UPDATE_CURRENT);
            callDialogPendingIntent = PendingIntent.getBroadcast(AppController.getContext(), 1202, callDialogAction, PendingIntent.FLAG_UPDATE_CURRENT);
