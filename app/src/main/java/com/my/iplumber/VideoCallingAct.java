...
import com.my.iplumber.act.utility.MusicManager;
...
//                    mLogView.logI("User offline, uid: " + (uid & 0xFFFFFFFFL));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MusicManager.getInstance().initalizeMediaPlayer(this, Uri.parse
                (ContentResolver.SCHEME_ANDROID_RESOURCE + "://" + getPackageName() + "/" + R.raw.out_caller));
...
//            mRtcEngine = RtcEngine.create(getBaseContext(), getString(R.string.agora_app_id), mRtcEventHandler);
            ...
            mRtcEngine = RtcEngine.create(getBaseContext(), "33ff465b3c2243f29377b570f0bdd275", mRtcEventHandler);
...
////      token ="00633ff465b3c2243f29377b570f0bdd275IAD2hYryx9HOd5OhGji5nWgr6jugimD1IC7nzV8WY7aHuXTCrBEAAAAAEAArT8zL21W9YgEAAQDbVb1i";
//
//        if (TextUtils.isEmpty(token) || TextUtils.equals(token, "00633ff465b3c2243f29377b570f0bdd275IAD2hYryx9HOd5OhGji5nWgr6jugimD1IC7nzV8WY7aHuXTCrBEAAAAAEAArT8zL21W9YgEAAQDbVb1i")) {
