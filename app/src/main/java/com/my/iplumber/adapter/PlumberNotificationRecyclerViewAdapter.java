...
public class PlumberNotificationRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public PlumberNotificationRecyclerViewAdapter(Context context, ArrayList<SuccessResGetNotification.Result> modelList) {
